    ...
    try {
      ...
      if (userData != null && userData.isNotEmpty) {
        ...
        return AccountProfileData(
          fullName: fullName,
          email: email.isNotEmpty ? email : '$username@email.com',
          initials: initials,
        );
      }
