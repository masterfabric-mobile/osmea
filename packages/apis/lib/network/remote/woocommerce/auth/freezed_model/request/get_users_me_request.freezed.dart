...
GetUsersMeRequest _$GetUsersMeRequestFromJson(Map<String, dynamic> json) {
  return _GetUsersMeRequest.fromJson(json);
}

/// @nodoc
mixin _$GetUsersMeRequest {
  @JsonKey(name: "id")
  ...
  @JsonKey(ignore: true)
  $GetUsersMeRequestCopyWith<GetUsersMeRequest> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $GetUsersMeRequestCopyWith<$Res> {
  factory $GetUsersMeRequestCopyWith(
          GetUsersMeRequest value, $Res Function(GetUsersMeRequest) then) =
      _$GetUsersMeRequestCopyWithImpl<$Res, GetUsersMeRequest>;
  @useResult
  $Res call(
...
/// @nodoc
class _$GetUsersMeRequestCopyWithImpl<$Res, $Val extends GetUsersMeRequest>
    implements $GetUsersMeRequestCopyWith<$Res> {
  _$GetUsersMeRequestCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$GetUsersMeRequestImplCopyWith<$Res>
    implements $GetUsersMeRequestCopyWith<$Res> {
  factory _$$GetUsersMeRequestImplCopyWith(_$GetUsersMeRequestImpl value,
          $Res Function(_$GetUsersMeRequestImpl) then) =
      __$$GetUsersMeRequestImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$GetUsersMeRequestImplCopyWithImpl<$Res>
    extends _$GetUsersMeRequestCopyWithImpl<$Res, _$GetUsersMeRequestImpl>
    implements _$$GetUsersMeRequestImplCopyWith<$Res> {
  __$$GetUsersMeRequestImplCopyWithImpl(_$GetUsersMeRequestImpl _value,
      $Res Function(_$GetUsersMeRequestImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$GetUsersMeRequestImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$GetUsersMeRequestImpl implements _GetUsersMeRequest {
  const _$GetUsersMeRequestImpl(
  ...
  factory _$GetUsersMeRequestImpl.fromJson(Map<String, dynamic> json) =>
      _$$GetUsersMeRequestImplFromJson(json);
  ...
  @override
  String toString() {
    return 'GetUsersMeRequest(id: $id, name: $name, url: $url, description: $description, link: $link, slug: $slug, avatarUrls: $avatarUrls, meta: $meta, isSuperAdmin: $isSuperAdmin, woocommerceMeta: $woocommerceMeta, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$GetUsersMeRequestImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$GetUsersMeRequestImplCopyWith<_$GetUsersMeRequestImpl> get copyWith =>
      __$$GetUsersMeRequestImplCopyWithImpl<_$GetUsersMeRequestImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$GetUsersMeRequestImplToJson(
      this,
    );
  }
}

abstract class _GetUsersMeRequest implements GetUsersMeRequest {
  const factory _GetUsersMeRequest(
      ...
      @JsonKey(name: "_links") final Links? links}) = _$GetUsersMeRequestImpl;

  factory _GetUsersMeRequest.fromJson(Map<String, dynamic> json) =
      _$GetUsersMeRequestImpl.fromJson;
