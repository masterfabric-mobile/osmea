...
class _ApiWooAuthService implements ApiWooAuthService {
  ...
  @override
  Future<GetUsersMeResponse> getUsersMe(String jwt) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<GetUsersMeResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _value = GetUsersMeResponse.fromJson(_result.data!);
    return _value;
  }
