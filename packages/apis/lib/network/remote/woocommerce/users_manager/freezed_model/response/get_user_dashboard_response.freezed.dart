...
/// @nodoc
mixin _$GetUserDashboardResponse {
  ...
  Map<String, UserPreference> get preferences =>
      throw _privateConstructorUsedError;
  List<UserContract> get contracts => throw _privateConstructorUsedError;
  ...
  @JsonKey(ignore: true)
  $GetUserDashboardResponseCopyWith<GetUserDashboardResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $GetUserDashboardResponseCopyWith<$Res> {
  factory $GetUserDashboardResponseCopyWith(GetUserDashboardResponse value,
          $Res Function(GetUserDashboardResponse) then) =
      _$GetUserDashboardResponseCopyWithImpl<$Res, GetUserDashboardResponse>;
  @useResult
  $Res call(
      {UserProfile profile,
      Map<String, UserMetadataItem> metadata,
      List<UserAddress> addresses,
      Map<String, UserPreference> preferences,
      List<UserContract> contracts,
...
/// @nodoc
class _$GetUserDashboardResponseCopyWithImpl<$Res,
        $Val extends GetUserDashboardResponse>
    implements $GetUserDashboardResponseCopyWith<$Res> {
  _$GetUserDashboardResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$GetUserDashboardResponseImplCopyWith<$Res>
    implements $GetUserDashboardResponseCopyWith<$Res> {
  factory _$$GetUserDashboardResponseImplCopyWith(
          _$GetUserDashboardResponseImpl value,
          $Res Function(_$GetUserDashboardResponseImpl) then) =
      __$$GetUserDashboardResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {UserProfile profile,
...
/// @nodoc
class __$$GetUserDashboardResponseImplCopyWithImpl<$Res>
    extends _$GetUserDashboardResponseCopyWithImpl<$Res,
        _$GetUserDashboardResponseImpl>
    implements _$$GetUserDashboardResponseImplCopyWith<$Res> {
  __$$GetUserDashboardResponseImplCopyWithImpl(
      _$GetUserDashboardResponseImpl _value,
      $Res Function(_$GetUserDashboardResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$GetUserDashboardResponseImpl(
      profile: null == profile
          ? _value.profile
          : profile // ignore: cast_nullable_to_non_nullable
              as UserProfile,
...
class _$GetUserDashboardResponseImpl implements _GetUserDashboardResponse {
  const _$GetUserDashboardResponseImpl(
      ...
      required final List<UserContract> contracts,
      required final List<UserOrder> orders,
  ...
  final List<UserContract> _contracts;
  @override
  List<UserContract> get contracts {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$GetUserDashboardResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$GetUserDashboardResponseImplCopyWith<_$GetUserDashboardResponseImpl>
      get copyWith => __$$GetUserDashboardResponseImplCopyWithImpl<
          _$GetUserDashboardResponseImpl>(this, _$identity);
}

abstract class _GetUserDashboardResponse implements GetUserDashboardResponse {
  const factory _GetUserDashboardResponse(
...
UserContract _$UserContractFromJson(Map<String, dynamic> json) {
  return _UserContract.fromJson(json);
}

/// @nodoc
mixin _$UserContract {
  @JsonKey(name: 'id')
  int get id => throw _privateConstructorUsedError;
  ...
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $UserContractCopyWith<UserContract> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $UserContractCopyWith<$Res> {
  factory $UserContractCopyWith(
          UserContract value, $Res Function(UserContract) then) =
      _$UserContractCopyWithImpl<$Res, UserContract>;
  @useResult
  $Res call(
      {@JsonKey(name: 'id') int id,
...
/// @nodoc
class _$UserContractCopyWithImpl<$Res, $Val extends UserContract>
    implements $UserContractCopyWith<$Res> {
  _$UserContractCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$UserContractImplCopyWith<$Res>
    implements $UserContractCopyWith<$Res> {
  factory _$$UserContractImplCopyWith(
          _$UserContractImpl value, $Res Function(_$UserContractImpl) then) =
      __$$UserContractImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'id') int id,
...
/// @nodoc
class __$$UserContractImplCopyWithImpl<$Res>
    extends _$UserContractCopyWithImpl<$Res, _$UserContractImpl>
    implements _$$UserContractImplCopyWith<$Res> {
  __$$UserContractImplCopyWithImpl(
      _$UserContractImpl _value, $Res Function(_$UserContractImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$UserContractImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int,
...
class _$UserContractImpl implements _UserContract {
  ...
  factory _$UserContractImpl.fromJson(Map<String, dynamic> json) =>
      _$$UserContractImplFromJson(json);
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, contractType, contractTitle, signedAt);

  @JsonKey(ignore: true)
  @override
  @pragma('vm:prefer-inline')
  _$$UserContractImplCopyWith<_$UserContractImpl> get copyWith =>
      __$$UserContractImplCopyWithImpl<_$UserContractImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$UserContractImplToJson(
      this,
    );
  }
}

abstract class _UserContract implements UserContract {
  const factory _UserContract(
          {@JsonKey(name: 'id') required final int id,
  ...
  factory _UserContract.fromJson(Map<String, dynamic> json) =
      _$UserContractImpl.fromJson;
...
abstract class _UserActivity implements UserActivity {
  const factory _UserActivity(
      ...
      @JsonKey(name: 'metadata') final Map<String, dynamic>? metadata,
      @JsonKey(name: 'created_at')
      required final String createdAt}) = _$UserActivityImpl;
...
abstract class _UserStatistics implements UserStatistics {
  const factory _UserStatistics(
      ...
      @JsonKey(name: 'orders_by_status')
      final Map<String, int>? ordersByStatus}) = _$UserStatisticsImpl;
