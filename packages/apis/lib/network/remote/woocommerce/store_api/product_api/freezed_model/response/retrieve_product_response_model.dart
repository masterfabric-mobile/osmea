...
//
//     final retrieveProductResponseModel = retrieveProductResponseModelFromJson(jsonString);

import 'package:freezed_annotation/freezed_annotation.dart';
import 'dart:convert';

part 'retrieve_product_response_model.freezed.dart';
part 'retrieve_product_response_model.g.dart';

RetrieveProductResponseModel retrieveProductResponseModelFromJson(String str) => RetrieveProductResponseModel.fromJson(json.decode(str));

String retrieveProductResponseModelToJson(RetrieveProductResponseModel data) => json.encode(data.toJson());

@freezed
class RetrieveProductResponseModel with _$RetrieveProductResponseModel {
    const factory RetrieveProductResponseModel({
        @JsonKey(name: "id")
        int? id,
        @JsonKey(name: "name")
        String? name,
    ...
    }) = _RetrieveProductResponseModel;

    factory RetrieveProductResponseModel.fromJson(Map<String, dynamic> json) => _$RetrieveProductResponseModelFromJson(json);
}
