...
part of 'retrieve_product_by_slug_response_model.dart';
...
RetrieveProductBySlugResponseModel _$RetrieveProductBySlugResponseModelFromJson(
    Map<String, dynamic> json) {
  return _RetrieveProductBySlugResponseModel.fromJson(json);
}

/// @nodoc
mixin _$RetrieveProductBySlugResponseModel {
  @JsonKey(name: "id")
  ...
  @JsonKey(ignore: true)
  $RetrieveProductBySlugResponseModelCopyWith<
          RetrieveProductBySlugResponseModel>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $RetrieveProductBySlugResponseModelCopyWith<$Res> {
  factory $RetrieveProductBySlugResponseModelCopyWith(
          RetrieveProductBySlugResponseModel value,
          $Res Function(RetrieveProductBySlugResponseModel) then) =
      _$RetrieveProductBySlugResponseModelCopyWithImpl<$Res,
          RetrieveProductBySlugResponseModel>;
  @useResult
  $Res call(
...
/// @nodoc
class _$RetrieveProductBySlugResponseModelCopyWithImpl<$Res,
        $Val extends RetrieveProductBySlugResponseModel>
    implements $RetrieveProductBySlugResponseModelCopyWith<$Res> {
  _$RetrieveProductBySlugResponseModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$RetrieveProductBySlugResponseModelImplCopyWith<$Res>
    implements $RetrieveProductBySlugResponseModelCopyWith<$Res> {
  factory _$$RetrieveProductBySlugResponseModelImplCopyWith(
          _$RetrieveProductBySlugResponseModelImpl value,
          $Res Function(_$RetrieveProductBySlugResponseModelImpl) then) =
      __$$RetrieveProductBySlugResponseModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$RetrieveProductBySlugResponseModelImplCopyWithImpl<$Res>
    extends _$RetrieveProductBySlugResponseModelCopyWithImpl<$Res,
        _$RetrieveProductBySlugResponseModelImpl>
    implements _$$RetrieveProductBySlugResponseModelImplCopyWith<$Res> {
  __$$RetrieveProductBySlugResponseModelImplCopyWithImpl(
      _$RetrieveProductBySlugResponseModelImpl _value,
      $Res Function(_$RetrieveProductBySlugResponseModelImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$RetrieveProductBySlugResponseModelImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$RetrieveProductBySlugResponseModelImpl
    implements _RetrieveProductBySlugResponseModel {
  const _$RetrieveProductBySlugResponseModelImpl(
  ...
  factory _$RetrieveProductBySlugResponseModelImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$RetrieveProductBySlugResponseModelImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$RetrieveProductBySlugResponseModelImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$RetrieveProductBySlugResponseModelImplCopyWith<
          _$RetrieveProductBySlugResponseModelImpl>
      get copyWith => __$$RetrieveProductBySlugResponseModelImplCopyWithImpl<
          _$RetrieveProductBySlugResponseModelImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$RetrieveProductBySlugResponseModelImplToJson(
      this,
    );
  }
}

abstract class _RetrieveProductBySlugResponseModel
    implements RetrieveProductBySlugResponseModel {
  const factory _RetrieveProductBySlugResponseModel(
      ...
      @JsonKey(name: "extensions")
      final Extensions? extensions}) = _$RetrieveProductBySlugResponseModelImpl;

  factory _RetrieveProductBySlugResponseModel.fromJson(
          Map<String, dynamic> json) =
      _$RetrieveProductBySlugResponseModelImpl.fromJson;
