...
RetrieveProductResponseModel _$RetrieveProductResponseModelFromJson(
    Map<String, dynamic> json) {
  return _RetrieveProductResponseModel.fromJson(json);
}

/// @nodoc
mixin _$RetrieveProductResponseModel {
  @JsonKey(name: "id")
  ...
  @JsonKey(ignore: true)
  $RetrieveProductResponseModelCopyWith<RetrieveProductResponseModel>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $RetrieveProductResponseModelCopyWith<$Res> {
  factory $RetrieveProductResponseModelCopyWith(
          RetrieveProductResponseModel value,
          $Res Function(RetrieveProductResponseModel) then) =
      _$RetrieveProductResponseModelCopyWithImpl<$Res,
          RetrieveProductResponseModel>;
  @useResult
  $Res call(
...
/// @nodoc
class _$RetrieveProductResponseModelCopyWithImpl<$Res,
        $Val extends RetrieveProductResponseModel>
    implements $RetrieveProductResponseModelCopyWith<$Res> {
  _$RetrieveProductResponseModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$RetrieveProductResponseModelImplCopyWith<$Res>
    implements $RetrieveProductResponseModelCopyWith<$Res> {
  factory _$$RetrieveProductResponseModelImplCopyWith(
          _$RetrieveProductResponseModelImpl value,
          $Res Function(_$RetrieveProductResponseModelImpl) then) =
      __$$RetrieveProductResponseModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$RetrieveProductResponseModelImplCopyWithImpl<$Res>
    extends _$RetrieveProductResponseModelCopyWithImpl<$Res,
        _$RetrieveProductResponseModelImpl>
    implements _$$RetrieveProductResponseModelImplCopyWith<$Res> {
  __$$RetrieveProductResponseModelImplCopyWithImpl(
      _$RetrieveProductResponseModelImpl _value,
      $Res Function(_$RetrieveProductResponseModelImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$RetrieveProductResponseModelImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$RetrieveProductResponseModelImpl
    implements _RetrieveProductResponseModel {
  const _$RetrieveProductResponseModelImpl(
  ...
  factory _$RetrieveProductResponseModelImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$RetrieveProductResponseModelImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$RetrieveProductResponseModelImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$RetrieveProductResponseModelImplCopyWith<
          _$RetrieveProductResponseModelImpl>
      get copyWith => __$$RetrieveProductResponseModelImplCopyWithImpl<
          _$RetrieveProductResponseModelImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$RetrieveProductResponseModelImplToJson(
      this,
    );
  }
}

abstract class _RetrieveProductResponseModel
    implements RetrieveProductResponseModel {
  const factory _RetrieveProductResponseModel(
      ...
      @JsonKey(name: "extensions")
      final Extensions? extensions}) = _$RetrieveProductResponseModelImpl;

  factory _RetrieveProductResponseModel.fromJson(Map<String, dynamic> json) =
      _$RetrieveProductResponseModelImpl.fromJson;
