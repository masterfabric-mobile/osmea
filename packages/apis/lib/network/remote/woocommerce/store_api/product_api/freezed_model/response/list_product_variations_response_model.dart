...
List<ListProductVariationsResponseModel> listProductVariationsResponseModelFromJson(String str) => List<ListProductVariationsResponseModel>.from(json.decode(str).map((x) => ListProductVariationsResponseModel.fromJson(x)));

String listProductVariationsResponseModelToJson(List<ListProductVariationsResponseModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

@freezed
class ListProductVariationsResponseModel with _$ListProductVariationsResponseModel {
    ...
    factory ListProductVariationsResponseModel.fromJson(Map<String, dynamic> json) => _$ListProductVariationsResponseModelFromJson(json);
}
