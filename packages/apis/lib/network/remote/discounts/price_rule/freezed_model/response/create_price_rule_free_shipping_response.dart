...
//
//     final createPriceRuleFreeShippingResponse = createPriceRuleFreeShippingResponseFromJson(jsonString);

import 'package:freezed_annotation/freezed_annotation.dart';
import 'dart:convert';

part 'create_price_rule_free_shipping_response.freezed.dart';
part 'create_price_rule_free_shipping_response.g.dart';

CreatePriceRuleFreeShippingResponse createPriceRuleFreeShippingResponseFromJson(
        String str) =>
    CreatePriceRuleFreeShippingResponse.fromJson(json.decode(str));

String createPriceRuleFreeShippingResponseToJson(
        CreatePriceRuleFreeShippingResponse data) =>
    json.encode(data.toJson());

@freezed
class CreatePriceRuleFreeShippingResponse
    with _$CreatePriceRuleFreeShippingResponse {
  const factory CreatePriceRuleFreeShippingResponse({
    @JsonKey(name: "price_rule") PriceRule? priceRule,
  }) = _CreatePriceRuleFreeShippingResponse;

  factory CreatePriceRuleFreeShippingResponse.fromJson(
          Map<String, dynamic> json) =>
      _$CreatePriceRuleFreeShippingResponseFromJson(json);
}
