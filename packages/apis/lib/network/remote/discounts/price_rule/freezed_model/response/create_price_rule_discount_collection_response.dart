...
part 'create_price_rule_discount_collection_response.freezed.dart';
part 'create_price_rule_discount_collection_response.g.dart';

CreatePriceRuleDiscountCollectionResponse
    createPriceRuleDiscountCollectionResponseFromJson(String str) =>
        CreatePriceRuleDiscountCollectionResponse.fromJson(json.decode(str));

String createPriceRuleDiscountCollectionResponseToJson(
        CreatePriceRuleDiscountCollectionResponse data) =>
    json.encode(data.toJson());

@freezed
class CreatePriceRuleDiscountCollectionResponse
    with _$CreatePriceRuleDiscountCollectionResponse {
  const factory CreatePriceRuleDiscountCollectionResponse({
    @JsonKey(name: "price_rule") PriceRule? priceRule,
  }) = _CreatePriceRuleDiscountCollectionResponse;

  factory CreatePriceRuleDiscountCollectionResponse.fromJson(
          Map<String, dynamic> json) =>
      _$CreatePriceRuleDiscountCollectionResponseFromJson(json);
}
