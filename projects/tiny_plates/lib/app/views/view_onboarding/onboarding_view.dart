/*
 * Tiny Plates Onboarding – MasterViewHydratedCubit + ViewModel + OnboardingContent.
...
import 'package:tiny_plates/app/views/view_onboarding/widgets/onboarding_content.dart';

class TinyPlatesOnboardingView extends MasterViewHydratedCubit<
    OnboardingViewModel, OnboardingState> {
  TinyPlatesOnboardingView({
    super.key,
    super.arguments,
    super.currentView,
