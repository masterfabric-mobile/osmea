...
class DealsOfDayCarouselWidget extends StatelessWidget {
  ...
  List<int> _getDealsProductIds(Map<String, dynamic> cfg) {
  ...
  int _getDealsLimit(Map<String, dynamic> cfg) {
    ...
    // Keep this bounded to avoid building huge carousels by mistake
    return limit.clamp(1, 20);
  }

  List<ListAllProductsResponseModel> _pickDealsProducts(
  ...
  Widget _buildLowPriceBannerCard(
    ...
    // Intentionally: Week Star badge should NOT appear in Deals of Day.
