...
class _BottomForegroundBannerWidgetState
  ...
  void _handleBannerTap() {
    ...
    if (route != null && route.isNotEmpty) {
      ...
      widget.goRoute('/categories/products/$categoryId');
  ...
  Widget build(BuildContext context) {
    ...
    final navbarHeight = safeAreaBottom + tailBottomOffset;
    ...
    return Stack(
      ...
      children: [
        ...
        // Tail indicator (visible when banner is hidden)
        if (!_isVisible)
          Positioned(
            left: (screenSize.width - tailWidth) / 2,
            bottom: tailBottomPosition,
            child: GestureDetector(
