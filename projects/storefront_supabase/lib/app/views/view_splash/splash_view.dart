...
class _SupabaseSplashViewState extends State<SupabaseSplashView>
  ...
  Widget build(BuildContext context) {
    ...
    final appName = configHelper.getString('app_settings.app_name', 'Storefront Supabase');
    final appVersion = configHelper.getString('app_settings.app_version', '1.0.0');
    ...
    final textColor = _parseColor(
      configHelper.getString('splash_configuration.app_name_text_color', '#000000'),
    );
