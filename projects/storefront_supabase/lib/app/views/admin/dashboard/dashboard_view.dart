    ...
    return OsmeaComponents.container(
      ...
      child: OsmeaComponents.column(
        children: [
          ...
          Divider(height: 1, color: OsmeaColors.silver.withOpacity(0.4)),
          _buildQuickAccessTile(context, icon: Icons.rate_review_outlined, title: 'Reviews', subtitle: 'Product reviews', onTap: () => goRoute(AdminRoutes.reviews)),
          Divider(height: 1, color: OsmeaColors.silver.withOpacity(0.4)),
          _buildQuickAccessTile(context, icon: Icons.location_on_outlined, title: 'Addresses', subtitle: 'User addresses', onTap: () => goRoute(AdminRoutes.addresses)),
          Divider(height: 1, color: OsmeaColors.silver.withOpacity(0.4)),
          _buildQuickAccessTile(context, icon: Icons.people_outline, title: resources.users, onTap: () => goRoute(AdminRoutes.users)),
          Divider(height: 1, color: OsmeaColors.silver.withOpacity(0.4)),
          _buildQuickAccessTile(context, icon: Icons.badge_outlined, title: 'Staff', subtitle: 'admin_users', onTap: () => goRoute(AdminRoutes.staff)),
          Divider(height: 1, color: OsmeaColors.silver.withOpacity(0.4)),
          _buildQuickAccessTile(context, icon: Icons.manage_accounts_outlined, title: 'Sessions', subtitle: 'admin_sessions', onTap: () => goRoute(AdminRoutes.sessions)),
          Divider(height: 1, color: OsmeaColors.silver.withOpacity(0.4)),
          _buildQuickAccessTile(context, icon: Icons.list_alt_outlined, title: 'Activity log', subtitle: 'admin_activity_log', onTap: () => goRoute(AdminRoutes.activityLog)),
          Divider(height: 1, color: OsmeaColors.silver.withOpacity(0.4)),
          _buildQuickAccessTile(context, icon: Icons.gavel_outlined, title: 'Moderation', subtitle: 'product_moderation', onTap: () => goRoute(AdminRoutes.moderation)),
          Divider(height: 1, color: OsmeaColors.silver.withOpacity(0.4)),
          ...
          Divider(height: 1, color: OsmeaColors.silver.withOpacity(0.4)),
          _buildQuickAccessTile(context, icon: Icons.analytics_outlined, title: 'Reports', subtitle: 'Revenue & orders by period', onTap: () => goRoute(AdminRoutes.reports)),
          Divider(height: 1, color: OsmeaColors.silver.withOpacity(0.4)),
