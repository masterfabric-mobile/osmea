...
class TranslationsTr with BaseTranslations<AppLocale, Translations> implements Translations {
	...
	@override String get currency => TranslationOverrides.string(_root.$meta, 'currency', {}) ?? 'Para birimi';
	...
	@override String get generalSettings => TranslationOverrides.string(_root.$meta, 'generalSettings', {}) ?? 'Genel ayarlar';
	...
	@override String get storeSettingsKeyValue => TranslationOverrides.string(_root.$meta, 'storeSettingsKeyValue', {}) ?? 'Mağaza ayarları (anahtar-değer)';
	@override String get storeSettingsKeyValueDescription => TranslationOverrides.string(_root.$meta, 'storeSettingsKeyValueDescription', {}) ?? 'admin_settings içindeki tüm anahtar-değer çiftleri. Düzenlemek için satıra dokunun veya yeni anahtar ekleyin (örn. maintenance_mode, guest_checkout_enabled).';
	@override String get maintenanceMode => TranslationOverrides.string(_root.$meta, 'maintenanceMode', {}) ?? 'Bakım modu';
	@override String get maintenanceModeSubtitle => TranslationOverrides.string(_root.$meta, 'maintenanceModeSubtitle', {}) ?? 'Açıkken mağaza müşterilere bakım mesajı gösterebilir.';
	@override String get guestCheckout => TranslationOverrides.string(_root.$meta, 'guestCheckout', {}) ?? 'Misafir ödeme';
	@override String get guestCheckoutSubtitle => TranslationOverrides.string(_root.$meta, 'guestCheckoutSubtitle', {}) ?? 'Hesap oluşturmadan ödeme yapılabilir.';
	@override String get defaultCurrency => TranslationOverrides.string(_root.$meta, 'defaultCurrency', {}) ?? 'Varsayılan para birimi';
	@override String get defaultCurrencySubtitle => TranslationOverrides.string(_root.$meta, 'defaultCurrencySubtitle', {}) ?? 'Kullanıcı para birimi seçmemişse uygulamada varsayılan olarak gösterilir.';
	...
	@override String get defaultLabel => TranslationOverrides.string(_root.$meta, 'defaultLabel', {}) ?? 'Varsayılan';
