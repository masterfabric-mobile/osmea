...
///
/// Locales: 4
/// Strings: 1112 (278 per locale)
///
/// Built on 2026-02-18 at 18:54 UTC
...
import 'resources_de.g.dart' deferred as l_de;
import 'resources_fr.g.dart' deferred as l_fr;
import 'resources_tr.g.dart' deferred as l_tr;
part 'resources_en.g.dart';
...
/// Translation happens during initialization of the widget (call of resources).
/// Configurable via 'translate_var'.
///
/// Usage:
/// String a = resources.someKey.anotherKey;
/// String b = resources['someKey.anotherKey']; // Only for edge cases!
Translations get resources => LocaleSettings.instance.currentTranslations;
...
///
/// Step 2:
/// final resources = Translations.of(context); // Get resources variable.
/// String a = resources.someKey.anotherKey; // Use resources variable.
/// String b = resources['someKey.anotherKey']; // Only for edge cases!
...
/// context.resources.someKey.anotherKey
extension BuildContextTranslationsExtension on BuildContext {
	Translations get resources => TranslationProvider.of(this).translations;
}
