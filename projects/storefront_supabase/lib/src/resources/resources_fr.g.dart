...
class TranslationsFr with BaseTranslations<AppLocale, Translations> implements Translations {
	...
	@override String get currency => TranslationOverrides.string(_root.$meta, 'currency', {}) ?? 'Devise';
	...
	@override String get generalSettings => TranslationOverrides.string(_root.$meta, 'generalSettings', {}) ?? 'Paramètres généraux';
	...
	@override String get storeSettingsKeyValue => TranslationOverrides.string(_root.$meta, 'storeSettingsKeyValue', {}) ?? 'Paramètres store (clé-valeur)';
	@override String get storeSettingsKeyValueDescription => TranslationOverrides.string(_root.$meta, 'storeSettingsKeyValueDescription', {}) ?? 'Toutes les paires clé-valeur de admin_settings. Appuyez pour modifier ou ajouter une clé (ex. maintenance_mode, guest_checkout_enabled).';
	@override String get maintenanceMode => TranslationOverrides.string(_root.$meta, 'maintenanceMode', {}) ?? 'Mode maintenance';
	@override String get maintenanceModeSubtitle => TranslationOverrides.string(_root.$meta, 'maintenanceModeSubtitle', {}) ?? 'Quand activé, les clients voient un message de maintenance.';
	@override String get guestCheckout => TranslationOverrides.string(_root.$meta, 'guestCheckout', {}) ?? 'Paiement invité';
	@override String get guestCheckoutSubtitle => TranslationOverrides.string(_root.$meta, 'guestCheckoutSubtitle', {}) ?? 'Autoriser le paiement sans créer de compte.';
	@override String get defaultCurrency => TranslationOverrides.string(_root.$meta, 'defaultCurrency', {}) ?? 'Devise par défaut';
	@override String get defaultCurrencySubtitle => TranslationOverrides.string(_root.$meta, 'defaultCurrencySubtitle', {}) ?? 'Devise par défaut dans l\'app si l\'utilisateur n\'a pas choisi.';
	...
	@override String get noStaffUsersFound => TranslationOverrides.string(_root.$meta, 'noStaffUsersFound', {}) ?? 'No staff users found.';
	...
	@override String get defaultLabel => TranslationOverrides.string(_root.$meta, 'defaultLabel', {}) ?? 'Par défaut';
