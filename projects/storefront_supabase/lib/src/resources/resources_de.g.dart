...
class TranslationsDe with BaseTranslations<AppLocale, Translations> implements Translations {
	...
	@override String get currency => TranslationOverrides.string(_root.$meta, 'currency', {}) ?? 'Währung';
	...
	@override String get generalSettings => TranslationOverrides.string(_root.$meta, 'generalSettings', {}) ?? 'Allgemeine Einstellungen';
	...
	@override String get storeSettingsKeyValue => TranslationOverrides.string(_root.$meta, 'storeSettingsKeyValue', {}) ?? 'Storeinstellungen (Schlüssel-Wert)';
	@override String get storeSettingsKeyValueDescription => TranslationOverrides.string(_root.$meta, 'storeSettingsKeyValueDescription', {}) ?? 'Alle Schlüssel-Wert-Paare aus admin_settings. Tippen zum Bearbeiten oder neuen Schlüssel hinzufügen (z. B. maintenance_mode, guest_checkout_enabled).';
	@override String get maintenanceMode => TranslationOverrides.string(_root.$meta, 'maintenanceMode', {}) ?? 'Wartungsmodus';
	@override String get maintenanceModeSubtitle => TranslationOverrides.string(_root.$meta, 'maintenanceModeSubtitle', {}) ?? 'Wenn aktiv, können Kunden eine Wartungsmeldung sehen.';
	@override String get guestCheckout => TranslationOverrides.string(_root.$meta, 'guestCheckout', {}) ?? 'Gastkasse';
	@override String get guestCheckoutSubtitle => TranslationOverrides.string(_root.$meta, 'guestCheckoutSubtitle', {}) ?? 'Kasse ohne Konto erlauben.';
	@override String get defaultCurrency => TranslationOverrides.string(_root.$meta, 'defaultCurrency', {}) ?? 'Standardwährung';
	@override String get defaultCurrencySubtitle => TranslationOverrides.string(_root.$meta, 'defaultCurrencySubtitle', {}) ?? 'Standardwährung in der App, wenn der Nutzer keine Wahl getroffen hat.';
	...
	@override String get defaultLabel => TranslationOverrides.string(_root.$meta, 'defaultLabel', {}) ?? 'Standard';
