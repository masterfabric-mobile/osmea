...
[![Shopify](https://img.shields.io/badge/shopify-2D3748?style=for-the-badge&logo=shopify&logoColor=white&labelColor=1A202C)](https://shopify.dev)
...
[![GitHub issues](https://img.shields.io/github/issues/masterfabric-mobile/osmea?style=for-the-badge&logo=github&logoColor=white&labelColor=1A202C)](https://github.com/masterfabric-mobile/osmea/issues)
[![GitHub pull requests](https://img.shields.io/github/issues-pr/masterfabric-mobile/osmea?style=for-the-badge&logo=github&logoColor=white&labelColor=1A202C)](https://github.com/masterfabric-mobile/osmea/pulls)
[![GitHub contributors](https://img.shields.io/github/contributors/masterfabric-mobile/osmea?style=for-the-badge&logo=github&logoColor=white&labelColor=1A202C)](https://github.com/masterfabric-mobile/osmea/graphs/contributors)
[![GitHub last commit](https://img.shields.io/github/last-commit/masterfabric-mobile/osmea?style=for-the-badge&logo=github&logoColor=white&labelColor=1A202C)](https://github.com/masterfabric-mobile/osmea/commits)
[![GitHub commit activity](https://img.shields.io/github/commit-activity/m/masterfabric-mobile/osmea?style=for-the-badge&logo=github&logoColor=white&labelColor=1A202C)](https://github.com/masterfabric-mobile/osmea/graphs/commit-activity)
[![License](https://img.shields.io/badge/license-AGPL%20v3.0-2D3748?style=for-the-badge&logo=gnu&logoColor=white&labelColor=1A202C)](LICENSE)
...
<img src = "https://github.com/masterfabric-mobile/osmea/blob/OSMEA-Docs/docs/assets/osmea_banner_v2.png?raw=true" width="800" alt="OSMEA Banner">
  ...
  **"OSMEA is not just a framework — it's an ecosystem."**
  ...
  [🚀 Live Demo](https://components.masterfabric.co) • [📚 Documentation](https://github.com/masterfabric-mobile/osmea/tree/dev/docs) • [🔍 API Explorer](https://github.com/masterfabric-mobile/osmea/tree/dev/projects/api_explorer) • [🎮 Component Showcase](https://components.masterfabric.co)
</div>
...
- [🏗️ OSMEA Ecosystem Architecture](#️-osmea-ecosystem-architecture)
...
**🌐 Homepage:** [https://osmea.masterfabric.co](https://osmea.masterfabric.co)
...
|-------------|----------|--------|---------|
| **[📊 Admin Dashboard](projects/admin_dashboard/)** | Web | 🔄 Development | Management interface with analytics |
| **[🔍 API Explorer](projects/api_explorer/)** | Web | ✅ Ready | API testing & debugging tool |
| **[🎮 Components App](projects/components_app/)** | All Platforms | ✅ Ready | Interactive component showcase |
| **[🛍️ Storefront Supabase](projects/storefront_supabase/)** | iOS/Android | 🔄 Development | Supabase-powered e-commerce app |
| **[🛒 Storefront Woo](projects/storefront_woo/)** | iOS/Android | 🔄 Development | WooCommerce integration app |
| **[📖 Storybook](projects/storybook/)** | Web | ✅ Ready | Component documentation hub |

### 🛠️ **Development Tools**

- ⚙️ **[Automated Setup](setup.sh)** - One-command initialization script
- 📚 **[Comprehensive Docs](docs/)** - Guides, checklists, examples
- 🧪 **Testing Framework** - Unit, widget, integration tests
- 📋 **[Development Rules](rules/)** - Coding standards and guidelines
- 🔌 **[Plugin Documentation](docs/plugins/)** - Extension guides
- 📊 **[Version Logs](docs/versions/)** - Release notes and history
---
...
#### **📊 Versions** - [`docs/versions/`](docs/versions/)
...
- 🎮 **[Components Showcase](https://components.masterfabric.co)** - Interactive component playground
- 🔍 **[API Explorer](https://github.com/masterfabric-mobile/osmea/tree/dev/projects/api_explorer)** - API testing interface
- 📚 **[Storybook](https://github.com/masterfabric-mobile/osmea/tree/dev/projects/storybook)** - Component documentation
...
<details>
<summary><strong>📊 Admin Dashboard</strong> - Management interface | 🌐 Web | 🔄 In Development</summary>

### [Admin Dashboard](projects/admin_dashboard/)
...
<details>
<summary><strong>🔍 API Explorer</strong> - API testing tool | 🌐 Web | ✅ Production Ready</summary>

### [API Explorer](projects/api_explorer/)
...
<details open>
<summary><strong>🎮 Components App</strong> - Interactive showcase | 📱 All Platforms | ✅ Production Ready | <a href="https://components.masterfabric.co">🚀 Live Demo</a></summary>

### [Components App](projects/components_app/)
...
**🌐 Try it now:** [https://components.masterfabric.co](https://components.masterfabric.co)

</details>

<details>
<summary><strong>🛍️ Storefront Supabase</strong> - Supabase e-commerce | 📱 iOS, Android | 🔄 In Development</summary>

### [Storefront Supabase](projects/storefront_supabase/)
...
<details>
<summary><strong>🛒 Storefront Woo</strong> - WooCommerce app | 📱 iOS, Android | 🔄 In Development</summary>

### [Storefront Woo](projects/storefront_woo/)
...
<details>
<summary><strong>📖 Storybook</strong> - Documentation hub | 🌐 Web | ✅ Production Ready</summary>
...
3. **💻 Make Your Changes**
   - Follow our [coding standards](rules/)
   - Write tests for new features
   - Update documentation
   - Follow the [commit guidelines](commits.md)
...
- 📝 **[Commit Guidelines](commits.md)** - How to write good commit messages
...
- 📋 **Full License**: [LICENSE](LICENSE) file
- 🏢 **Copyright**: © 2025 MasterFabric Mobile
- 🌐 **Official Website**: [https://osmea.masterfabric.co](https://osmea.masterfabric.co)
- 📧 **Contact**: support@masterfabric.co
...
- **[📖 Documentation](https://github.com/masterfabric-mobile/osmea/tree/dev/docs)** - Complete guides and API references
  - [📋 Checklists](docs/checklists/) - Implementation and verification guides
  - [🎯 Guidance](docs/guidance/) - Setup and configuration tutorials
  - [🔌 Plugins](docs/plugins/) - Extension documentation
  - [📊 Versions](docs/versions/) - Release notes and history

- **[🎮 Live Demo](https://components.masterfabric.co)** - Interactive component showcase
- **[📖 Component Storybook](https://github.com/masterfabric-mobile/osmea/tree/dev/projects/storybook)** - Component documentation and testing
- **[🔍 API Explorer](https://github.com/masterfabric-mobile/osmea/tree/dev/projects/api_explorer)** - API testing and exploration tool
...
- **[🔒 Security](mailto:security@masterfabric.co)** - Security vulnerability reports
...
- **[📝 Commit Guidelines](commits.md)** - Commit message conventions
- **[📋 Pull Request Template](pull_request_template.md)** - PR submission guide
...
**🌐 [Website](https://osmea.masterfabric.co)** • **📚 [Documentation](https://github.com/masterfabric-mobile/osmea/tree/dev/docs)** • **🐛 [Issues](https://github.com/masterfabric-mobile/osmea/issues)** • **💬 [Discussions](https://github.com/masterfabric-mobile/osmea/discussions)**
